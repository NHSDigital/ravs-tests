...
CHANGE_DATE_BUTTON = ("role", "button", "Change date")
CHANGE_VACCINES_BUTTON = ("role", "button", "Change vaccines")
CHANGE_SITES_BUTTON = ("role", "button", "Change sites")
CHANGE_DATA_BUTTON = ("role", "button", "Change data")
