...
PATIENT_GENDER_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Gender']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_ELIGIBLE_FOR_VACCINE_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Eligible']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_ELIGIBILITY_TYPE_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Eligibility type']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_ELIGIBILITY_ASSESSING_CLINICIAN_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Assessing clinician']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_ELIGIBILITY_ASSESSMENT_DATE_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Assessment date']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_ELIGIBILITY_ASSESSMENT_OUTCOME_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Assessment outcome']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_ELIGIBILITY_ASSESSMENT_COMMENTS_LABEL_ELEMENT = "xpath", ("(//div[@class='nhsuk-summary-list__row']/dt[text()='Comments']/following-sibling::dd[@class='nhsuk-summary-list__value'])[1]")
...
PATIENT_CONSENT_NAME_OF_PERSON_CONSENTING_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Name of the person consenting']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_CONSENT_PERSON_CONSENTING_RELATIONSHIP_TO_PARENT_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Relationship to the patient']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_CONSENT_RECORDED_BY_CLINICIAN_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Consenting clinician']/following-sibling::dd[@class='nhsuk-summary-list__value']")
CHANGE_RECORD_CONSENT_PAGE_DETAILS_BUTTON = ("xpath", "//button[text()='Change record consent page details']")
PATIENT_VACCINATED_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Vaccinated?']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_VACCINATION_DATE_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Date']/following-sibling::dd[@class='nhsuk-summary-list__value']")
...
PATIENT_VACCINE_PRODUCT_LABEL_ELEMENT = ("xpath", "(//div[@class='nhsuk-summary-list__row']/dt[text()='Product']/following-sibling::dd[@class='nhsuk-summary-list__value'])[1]")
...
PATIENT_VACCINE_BATCH_EXPIRY_DATE_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Expiry date']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_VACCINATION_SITE_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Site']/following-sibling::dd[@class='nhsuk-summary-list__value']")
PATIENT_VACCINATION_DOSE_AMOUNT_LABEL_ELEMENT = ("xpath", "//div[@class='nhsuk-summary-list__row']/dt[text()='Dose amount (ml)']/following-sibling::dd[@class='nhsuk-summary-list__value']")
...
PATIENT_VACCINATION_COMMENTS_LABEL_ELEMENT = ("xpath", "(//div[@class='nhsuk-summary-list__row']/dt[text()='Comments']/following-sibling::dd[@class='nhsuk-summary-list__value'])[2]")
CHANGE_VACCINATE_PAGE_DETAILS_BUTTON = ("role", "button", "Change vaccinate page details")
