Feature: Persist fields when recording vaccination
  ...
  Scenario Outline: Persist fields when recording a vaccination
    ...
    Examples:
      ...
      | 0     | 5997998967 | Weaverham Surgery | Vaccination Centre open to the public | yes         | today       | yes     | yes         | today            | JACKIE WALKER | 6/12/1953 | 9 Islington High Street Verwood, PA, NN6 6NZ | COVID-19       | AUTOMATION-SJ1 | 1/10/2026         | 9472710255     | DELICE PINKER    | Trust site         | lead administrator |
      | 1     | 5997998967 | Aspire Pharmacy   | Care home                             | yes         | today       | yes     | yes         | today            | JACKIE WALKER | 6/12/1953 | 9 Islington High Street Verwood, PA, NN6 6NZ | Flu            | AUTOMATION-SJ1 | 19/2/2026         | 9472710255     | DELICE PINKER    | Community pharmacy | administrator      |
  ...
  Scenario Outline: Fields should not persist when user changes delivery team when recording a vaccination
    ...
    Examples:
      ...
      | 2     | 5997998967 | Weaverham Surgery | Vaccination Centre open to the public | yes         | today       | yes     | yes         | today            | JACKIE WALKER | 6/12/1953 | 9 Islington High Street Verwood, PA, NN6 6NZ | COVID-19       | AUTOMATION-SJ1 | 10/10/2026        | 9472710255     | DELICE PINKER    | Trust site         | lead administrator | Spire Regency Hospital                                                            |
      | 1     | 5997998967 | Aspire Pharmacy   | Care home                             | yes         | today       | yes     | yes         | today            | JACKIE WALKER | 6/12/1953 | 9 Islington High Street Verwood, PA, NN6 6NZ | Flu            | AUTOMATION-SJ1 | 2/5/2026          | 9472710255     | DELICE PINKER    | Community pharmacy | administrator      | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service |
  ...
  Scenario Outline: Fields should not persist when user changes vaccine product when recording a vaccination
    ...
    Examples:
      ...
      | 5     | 5998022750 | Weaverham Surgery | Outreach event       | yes         | today-1     | yes     | yes         | today-1          | LAURIE QUINN | 2/2/1941 | 18 Regent Street Oakham, MI, DH3 3UW | COVID-19       | AUTOMATION-C10 | 5/10/2026         | 9449306125     | NEELY SCULLION   | Flu                 | Trust site         | lead administrator |
      | 6     | 5998022750 | Aspire Pharmacy   | Outreach event       | yes         | today-1     | yes     | yes         | today-1          | LAURIE QUINN | 2/2/1941 | 18 Regent Street Oakham, MI, DH3 3UW | COVID-19       | AUTOMATION-C10 | 28/2/2026         | 9449306125     | NEELY SCULLION   | Flu                 | Community pharmacy | administrator      |
  ...
  Scenario Outline: Fields should not persist when user changes vaccine product type when recording a vaccination
    ...
    Examples:
      | index | nhs_number | site              | vaccination_location | eligibility | assess_date | consent | vaccination | vaccination_date | name         | dob      | address                              | chosen_vaccine | batch_number   | batch_expiry_date | new_nhs_number | new_patient_name | care_model         | user_role          |
      | 6     | 5998022750 | Weaverham Surgery | Outreach event       | yes         | today-1     | yes     | yes         | today-1          | LAURIE QUINN | 2/2/1941 | 18 Regent Street Oakham, MI, DH3 3UW | COVID-19       | AUTOMATION-C10 | 1/3/2026          | 9449306125     | NEELY SCULLION   | Trust site         | lead administrator |
      | 7     | 5998022750 | Aspire Pharmacy   | Outreach event       | yes         | today-1     | yes     | yes         | today-1          | LAURIE QUINN | 2/2/1941 | 18 Regent Street Oakham, MI, DH3 3UW | Flu            | AUTOMATION-C10 | 31/12/2026        | 9449306125     | NEELY SCULLION   | Community pharmacy | administrator      |
