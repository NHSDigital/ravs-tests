...
Background:
  ...
  | 2     | 9470006739 | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service|GP clinic   |yes  | today| yes     | yes  | today-30  | JANNETTE ARD | 09/12/2015 | 1 ST. MARTINS COURT, CONISTON, CUMBRIA, LA21 8HZ | COVID-19 | Comirnaty 10 JN.1  |AUTO-10-CSC      | 19/10/2026 | female | lead administrator | community pharmacy |
  ...
  # | 8     | 9650594000 | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service|GP clinic   |yes  | today| yes     | yes  | today-200  | Archie STRAIN| 30/07/2014 | 1 CONINGSBY DRIVE, GRIMSBY, S HUMBERSIDE, DN34 5HQ | Flu | Quadrivalent Influenza Vaccine – High Dose (QIV-HD) | AUTO-QIHD-OM     | 19/10/2026 | female | lead administrator | community pharmacy |
...
@bsarecordvaccine
  ...
  Examples:
      ...
      # | 7     | 9733907723 | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service | Outreach event   | yes  | today| yes     | yes  | today-5    | Sandra Ryan    | 7/4/1994    | Flu | AUTO-QIVE-CSC   | 19/10/2026| recorder  | Community Pharmacy |
...
Examples:
      ...
      # | 2     | 9734250221   | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service | Vaccination Centre      | yes  | today| yes     | yes  | today-30   | BARAK SELIGMANN | 26/5/2016  | 170 WEELSBY ROAD, GRIMSBY, S HUMBERSIDE, DN32 8QQ | Flu | AUTO-SUP-N-F     | 19/10/2026 | recorder    | Community Pharmacy |
      ...
      # | 6     | 9467361590   | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service | Vaccination Centre      | yes  | today| yes     | yes  | today-14   | WALLIS ADEYEMO  | 19/4/2015  | 1 MIDLAND ROAD, LEEDS, LS6 1BQ  | COVID-19 | AUTO-SUP-C-1     | 19/10/2026 | lead administrator | Community Pharmacy    |
...
Examples:
    ...
    # | 4     | 9449304033  | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service | Vaccination Centre    | yes  | today| yes     | yes  | today-9    | BARAK SELIGMANN | Flu | AUTO-SUP-O-F      | 19/10/2026 | Community Pharmacy | administrator      |
...
@bsarecordvaccine
  ...
  Examples:
    ...
    # | 2     | 9449304424  | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service | Vaccination Centre   | yes  | today| yes     | yes  | today-25  | John Test | 02/01/1997 | 121C, Durants Road, ENFIELD, EN3 7DG | COVID-19 | AUTO-DEC-SJ1     | 19/10/2026 | recorder    | Community Pharmacy |
...
Examples:
  ...
  Examples:
    ...
    # | 2     | 9470040228  | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service | Hospital hub for staff and patients| yes  | today+290  | today-1     | yes     | yes  | today| HERBERT HAAG| 14/12/1922 | 10 COASTAL ROAD, HEST BANK, LANCASTER, LA2 6HN| Pertussis| AUTO-RVS | 19/02/2029 | lead administrator | Community Pharmacy |
    ...
    # | 6     | 9470004272  | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service | Vaccination Centre  |yes  | today+70   | today-1     | yes     | yes  | today-1   | JOJO LANE   | 06/07/2015 | 10 RAKESMOOR LANE, BARROW-IN-FURNESS, LA14 4LG| Respiratory syncytial virus (RSV)   |AUTOMATION-XYZ | 19/10/2026 | lead administrator | Community Pharmacy |
...
Examples:
    ...
    # | 4     | 9437541817  | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service | Outreach event | yes  | today| yes     | no  | today| FLORINDA DUNNER | 27/03/1957 | 32 HOLLAND ROAD, MANCHESTER, M8 4NP    | Flu | AUTO-NO-F-SJ1     | 19/10/2026| female | Community Pharmacy| administrator    |
    ...
    # | 4     | 9437541817  | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service   | Outreach event | yes  | today| no      | no  | today| FLORINDA DUNNER | 27/03/1957 | 32 HOLLAND ROAD, MANCHESTER, M8 4NP    | Flu | AUTO-NO-F-SJ1     | 19/10/2026| female | Community Pharmacy | recorder   |
...
@bsarecordvaccine
  Scenario Outline: NO MATERNITY - Record a maternity vaccine and choose no vaccination decision on the last screen in a GP clinic
    ...
    Examples:
      ...
      | 2 | 9470040228 | Aspire Pharmacy (The Concourse Shopping Centre) - Covid Local Vaccination Service | Hospital hub for staff and patients | yes | today+290 | today-1 | no | no | today  | HERBERT HAAG  | 14/12/1922 | 10 COASTAL ROAD, HEST BANK, LANCASTER, LA2 6HN | Pertussis | AUTO-RVS | 19/2/2029 | Community Pharmacy   | administrator    |
