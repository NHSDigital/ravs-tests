...
Feature: Record vaccine
  ...
  Scenario Outline: Record a vaccine with nhs number
    ...
    Examples:
      ...
      | 0 | 9470040228 | Weaverham Surgery  | Vaccination Centre open to the public | yes | today  | yes  | yes | today   | HERBERT HAAG |  14/12/1922 |   10 COASTAL ROAD, HEST BANK, LANCASTER, LA2 6HN | COVID-19   | AUTOMATION-SJ1   | 7/9/2025 | Trust site  | lead administrator |
