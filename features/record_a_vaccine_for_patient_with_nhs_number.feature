...
Feature: Record vaccine
  ...
  Scenario Outline: Record a vaccine with nhs number
    ...
    Examples:
      ...
      | 0     | 9470040228 | Weaverham Surgery       | Vaccination Centre open to the public | yes         | today       | yes     | yes         | today            | HERBERT HAAG   | 14/12/1922 | 10 COASTAL ROAD, HEST BANK, LANCASTER, LA2 6HN                       | COVID-19       | AUTOMATION-SJ1  | 7/9/2025          |
      | 1     | 9470040228 | Spire Cheshire Hospital | Hospital hub for staff and patients   | yes         | today-1     | yes     | yes         | today            | HERBERT HAAG   | 14/12/1922 | 10 COASTAL ROAD, HEST BANK, LANCASTER, LA2 6HN                       | COVID-19       | AUTOMATION-C10  | 19/2/2026         |
      ...
      | 1     | 9449303975 | Spire Regency Hospital  | Outreach event                        | yes         | today       | yes     | yes         | today            | ROS METHERALL  | 19/8/1999  | 10 GREENACRES, BOOKHAM, LEATHERHEAD, SURREY, KT23 3NG                | MMR            | AUTOMATION-MPR  | 19/10/2026        |
  ...
  Scenario Outline: Record a maternity vaccine with nhs number
    ...
    Examples:
      ...
      | 2     | 9470040228 | Spire Cheshire Hospital | Hospital hub for staff and patients | yes         | today+290 | today-1     | yes     | yes         | today            | HERBERT HAAG       | 14/12/1922 | 10 COASTAL ROAD, HEST BANK, LANCASTER, LA2 6HN                       | Pertussis                         | AUTOMATION-RVS | 19/2/2029         | Trust site | administrator |
