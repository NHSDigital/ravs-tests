...
@bsarecordvaccine
  Scenario Outline: Record a vaccine at community pharmacy - deceased patient
    ...
    Examples:
      ...
      | 0 | 9449304424 | Aspire Pharmacy  | Outreach event | yes | today  | yes  | yes | today-9    | John Test |  2/1/1997 |	121C, Durants Road, ENFIELD, EN3 7DG | COVID-19   | AUTO-AS-DEC-SJ1   | 19/10/2026 |
