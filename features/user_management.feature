...
| recorder           | Community pharmacy | administrator      | Aspire Pharmacy             |
| administrator      | Branch surgery     | administrator      | Aire Valley Surgery (rawdon)|
...
| Automated  | administrator          | neelima.guntupalli1+admin_automated@nhs.net                | yes              | administrator       | Weaverham Surgery   | Trust site        | administrator    |
| Automated  | administrator          | neelima.guntupalli1+admin_automated@nhs.test               | yes              | administrator       | Aspire Pharmacy     | Community pharmacy| administrator    |
| Automated  | tester                 | automated.tester@nhs.net                                    | yes              | recorder            | Aire Valley Surgery | Branch surgery    | recorder         |
...
| Bethany    | administrator          | bethany.north4+administrator_automated@stockport.nhs.uk     | no               | administrator       | Aspire Pharmacy     | Community pharmacy| administrator    |
| Bethany    | recorder               | bethany.north4+recorder_automated@swast.nhs.uk              | no               | recorder            | Aire Valley Surgery | Branch surgery    | recorder         |
| Bethany    | recorder               | bethany.north4+recorder_automated@nhs.scot                  | no               | recorder            | Weaverham Surgery   | Trust site        | recorder         |
| Bethany    | recorder               | bethany.north4+recorder_automated@nhs.uk                    | no               | recorder            | Leeds Pharmacy      | Community pharmacy| recorder         |
