flu_vaccine_add_batch_radio_button_xpath_map = {
        ...
        "cell-based quadrivalent - qivc": "//input[@class='nhsuk-radios__input' and @name='FluVaccineId' and @value='12']",
        "adjuvanted quadrivalent - aqiv": "//input[@class='nhsuk-radios__input' and @name='FluVaccineId' and @value='13']"
    }
